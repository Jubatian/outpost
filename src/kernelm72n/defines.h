 ...
 */
	...
	// The modded VSync mixer requires only a bit more than 1 frame
	// But since the game does some display reconfiguring on the fly, to
	// avoid cracking (as sample buffer processing is done just after
	// display frame end), toss more memory at it, we have enough.
	#define MIX_BANK_SIZE 160
